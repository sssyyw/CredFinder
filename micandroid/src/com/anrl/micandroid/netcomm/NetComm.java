...
public class NetComm {
	...
	// Debuggery
	private final static String TAG = "NetComm";

	// NET Stuffs
	private final static int PORT = 4999;
	private final static String ADDRESS = "192.197.121.9"; 
	//private final static String ADDRESS = "142.157.45.29";
	...
	public void endConnectThread(boolean hadError) {
		...
		writeOut("We are done", ENCRYPT); //add to close server gracefully
		try {
			in.close();
			out.flush();
			out.close();
